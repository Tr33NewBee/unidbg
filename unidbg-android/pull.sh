...
adb pull /system/lib/libEGL.so lib/
adb pull /system/lib/libGLESv1_CM.so lib/
adb pull /system/lib/libandroid.so lib/
...
adb pull /system/lib64/libEGL.so lib64/
adb pull /system/lib64/libGLESv1_CM.so lib64/
adb pull /system/lib64/libandroid.so lib64/
